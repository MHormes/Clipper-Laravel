        ...
        <div class="max-w-7xl mx-auto p-6">
            <div class="flex items-center justify-between mb-10">
                <div>
                    ...
                    <p class="text-muted-foreground font-bold uppercase tracking-widest text-xs mt-1">Review and approve new series submissions</p>
                </div>
            </div>

            <div v-if="series.length === 0" class="bg-white dark:bg-[#161615] rounded-3xl p-20 border border-sidebar-border text-center shadow-sm">
                ...
                <p class="text-muted-foreground font-medium max-w-md mx-auto">There are no pending series requests at the moment. Check back later!</p>
            </div>

            <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div v-for="item in series" :key="item.id" 
                     class="bg-white dark:bg-[#161615] rounded-3xl overflow-hidden border border-sidebar-border hover:border-orange-500/50 transition-all group/card shadow-sm">
