        ...
        <div class="w-full max-w-7xl mx-auto p-4 md:p-6">
            ...
            <div class="rounded-3xl border border-border-color bg-component-background p-4 shadow-sm">
                <div class="mb-4 flex items-center justify-between gap-3 px-2">
                    ...
                    <div
                        class="flex items-center gap-2 rounded-xl border border-border-color bg-primary-background px-3 py-2">
                ...
                <div v-if="markers.length === 0"
                    class="min-h-[560px] flex flex-col items-center justify-center rounded-2xl border border-dashed border-border-color bg-primary-background text-center px-6">
                    ...
                    <p class="mt-2 text-sm text-muted-content max-w-md">
                        Add a location to your collected clippers from the details modal, then they will appear as map
                        pins here.
                    </p>
                </div>

                <div v-else ref="mapEl"
                    class="relative z-0 h-[70vh] min-h-[560px] overflow-hidden rounded-2xl border border-border-color">
                </div>
            </div>
        </div>
    </AppLayout>
