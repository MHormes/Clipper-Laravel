...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div
            class="mx-auto flex h-full w-full max-w-7xl flex-1 flex-col gap-8 p-8"
        >
            <div
                class="grid grid-cols-2 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5"
            >
                <CursorCard
                    v-for="stat in stats"
                    :key="stat.label"
                ...
                >
                    <div class="relative z-10">
                        ...
                        >
                            <span
                                class="min-w-0 text-sm font-bold tracking-wider text-muted-content uppercase"
                                >{{ stat.label }}</span
                            >
                            <div
                                :class="[
                            ...
                            >
                                <component
                                    :is="getStatConfig(stat.label).icon"
                                    :class="[
                                        'h-5 w-5',
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
                <Link :href="route('series.index')" class="group">
                    ...
                    >
                        <div class="relative z-10">
                            ...
                            <p
                                class="max-w-[280px] text-sm leading-relaxed text-muted-content"
                            >
                                View all series, check missing designs, and
                                organize your sets.
                            </p>
                            <div
                                class="mt-8 flex items-center font-bold text-primary transition-all group-hover:gap-2"
                            >
                ...
                <Link :href="route('series.create')" class="group">
                    ...
                    >
                        <div class="relative z-10">
                            ...
                            <div
                                class="mt-8 flex items-center font-bold transition-all group-hover:gap-2"
                                :class="
                ...
                <Link
                    ...
                    "
                    :href="route('admin.requests.series.index')"
                    class="group"
                >
                    <CursorCard
                        ...
                        <div class="relative z-10">
                            <div class="mb-4 flex items-center justify-between">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="rounded-lg bg-primary p-2 text-button-content"
                                    >
                                        <ArrowRight
                                ...
                                <span
                                    class="rounded-full bg-primary px-3 py-1 text-xs font-black text-button-content"
                                >
                                    {{
                            ...
                            <p
                                class="text-sm font-bold tracking-tight text-primary uppercase"
                            >
                ...
                <Link
                    :href="route('series.index', { filter: 'collected' })"
                    class="group"
                >
                    <CursorCard
                    ...
                    >
                        <div class="relative z-10">
                            <div class="mb-4 flex items-center gap-3">
                                <div
                                    class="rounded-lg bg-info/10 p-2 text-info"
                                >
                            ...
                            <div
                                class="mt-8 flex items-center font-bold text-info transition-all group-hover:gap-2"
                            >
            ...
            <CursorCard
                className="flex-1 rounded-2xl border border-border-color p-6 shadow-sm bg-component-background"
            >
                <div class="relative z-10">
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            ...
                            >
                                <Skeleton
                                    v-if="!isRecentImageLoaded(item)"
                                    class="absolute inset-0 h-full w-full rounded-none"
                                />
                                <img
                                    v-show="isRecentImageLoaded(item)"
                                    :src="item.image_data"
                                    :alt="item.name + ' Clipper Lighter Series'"
                                    class="h-full w-full object-contain"
                                    @load="markRecentImageLoaded(item)"
                                    @error="markRecentImageLoaded(item)"
                                />
                            </div>
                            ...
                            <div class="flex-1">
                                ...
                                <p
                                    class="text-[10px] tracking-tight text-muted-content uppercase"
                                >
                                    {{ item.clippers_count }} Design(s)<span
