    ...
    <AppLayout>
        <div class="max-w-7xl mx-auto p-6">
            <div class="flex items-center gap-4 mb-10">
                ...
                <div>
                    <h1 class="text-4xl font-black uppercase tracking-tighter text-primary-content">My Clipper Requests</h1>
                    <p class="text-muted-content font-bold uppercase tracking-widest text-xs mt-1">Track your additions to existing series</p>
                </div>
            </div>
            ...
            <div v-if="Object.keys(groupedClippers).length === 0" class="bg-component-background rounded-3xl p-20 border border-border-color text-center shadow-sm relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-muted-content font-medium max-w-md mx-auto uppercase text-xs tracking-widest">You don't have any clipper requests waiting for approval.</p>
                </div>
            </div>
