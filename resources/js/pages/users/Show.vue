    ...
    <AppLayout>
        <div class="w-full max-w-7xl mx-auto p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-[320px,1fr] gap-6">
                <aside class="rounded-2xl border border-border-color bg-component-background p-5 h-fit lg:sticky lg:top-20">
                    <div class="flex items-center gap-3">
                        <div class="flex size-12 shrink-0 items-center justify-center rounded-xl bg-primary/10 text-primary text-lg font-black">
                            {{ initial }}
                        </div>
                        <div class="min-w-0">
                    ...
                    <div class="mt-6 space-y-3">
                        <div class="rounded-xl border border-border-color bg-primary-background p-3">
                            ...
                            <p class="mt-1 text-2xl font-black text-primary-content">{{ profile.collected_clippers_count }}</p>
                        </div>
                        ...
                        <div class="rounded-xl border border-border-color bg-primary-background p-3">
                            ...
                            <p class="mt-1 text-2xl font-black text-primary-content">{{ profile.completed_series_count }}</p>
                        </div>
                        ...
                        <div class="rounded-xl border border-border-color bg-primary-background p-3">
                            ...
                            <p class="mt-1 text-2xl font-black text-primary-content">{{ profile.contributions_count }}</p>
                        </div>
                    </div>
                </aside>
                ...
                <section>
                    <div class="grid grid-cols-1 lg:grid-cols-[1fr,auto] items-center gap-4 mb-8">
                        <div>
                            ...
                            <p class="text-sm text-muted-content">Browse this user's collected sets and completion progress.</p>
                        </div>
                    ...
                    <div v-else class="w-full flex flex-col items-center justify-center py-24 bg-component-background rounded-3xl border border-dashed border-border-color">
                        ...
                        <button @click="search = ''" class="px-8 py-4 bg-muted-background rounded-2xl font-black transition-all">
                            RESET SEARCH
                        </button>
                    </div>
